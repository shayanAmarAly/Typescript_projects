...
const enemy: string[] = ["Meruem","Yohan Liebert","Muzan","Yagami","Dio"]
var hero_health:number = 100
var enemy_health:number = 75
const enemyAttack_Damage:number = Math.ceil( Math.random() * 25)
const heroAttack_Damage:number= Math.ceil(Math.random() * 25)
let x = true
